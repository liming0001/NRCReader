...
@property (nonatomic, assign) BOOL hasKeepLive;//是否正在发送心跳
@property (nonatomic, assign) BOOL closeDeviceAuto;//关闭设备自动感应
...
/**
 ...
 @param NFCData <#dic description#>
 */
+ (void)SendDataWithData:(NSData*)NFCData;
