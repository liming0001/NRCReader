...
- (NSString *)MD5Sum {
	...
	CC_MD5(self.bytes, (int)self.length, digest);
...
- (NSString *)SHA1Sum {
	...
	CC_SHA1(self.bytes, (int)self.length, digest);
...
- (NSString *)SHA256Sum {
    ...
    CC_SHA256([self bytes], (int)[self length], digest);
...
+ (NSData *)dataWithBase64String:(NSString *)base64String {
	...
	const char *string = [base64String cStringUsingEncoding:NSUTF8StringEncoding];
