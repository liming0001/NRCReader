...
@interface CustomerEntryInfoView_workers ()
...
@implementation CustomerEntryInfoView_workers
...
-(void)sureEntryCustomerInfo:(NSNotification *)ntf {
    if ([self.zhuangValueTF.text intValue]==0&&[self.zhuangDuiValueTF.text intValue]==0&&[self.sixWinTF.text intValue]==0&&[self.xianTF.text intValue]==0&&[self.xianDuiValueTF.text intValue]==0&&[self.heValueTF.text intValue]==0&&[self.baoxianValueTF.text intValue]==0&&[self.washNumberTF.text length]==0) {
        ...
        [PublicHttpTool getInfoByXmh:self.washNumberTF.text WithBlock:^(BOOL success, id  _Nonnull data, NSString * _Nonnull msg) {
            if (success) {
                ...
                editCustomer.sixValueType = self.sixType;
                if (self.editTapCustomer) {
