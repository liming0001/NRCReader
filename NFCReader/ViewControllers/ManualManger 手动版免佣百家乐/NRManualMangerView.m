...
- (void)fengzhuangCustomerInfo{
    ...
    if ([self.curSelectCustomer.luckyValue integerValue]!=0) {//幸运6点
        NSString *luckyRealValue = [NSString stringWithFormat:@"幸运6点:%@",self.curSelectCustomer.luckyValue];
        [self.payKillResultInfo_list addObject:luckyRealValue];
        [self.fxmh_list addObject:[self.curSelectCustomer.washNumberValue NullToBlankString]];
        [self.fxz_money_list addObject:self.curSelectCustomer.luckyValue];
        ...
        if ([self.resultList containsObject:[NSNumber numberWithInteger:6]]) {//和
            ...
            if ([self.resultList containsObject:[NSNumber numberWithInteger:3]]) {//Lucky6
                [self.fsy_list addObject:[NSNumber numberWithInt:1]];
                CGFloat resultValue = (1+odds-yj)*[self.curSelectCustomer.luckyValue integerValue];
                [self.fresult_list addObject:[NSNumber numberWithDouble:resultValue]];
                CGFloat yjValue = yj*[self.curSelectCustomer.luckyValue integerValue];
                [self.fyj_list addObject:[NSNumber numberWithDouble:yjValue]];
                CGFloat payValue = (odds-yj)*[self.curSelectCustomer.luckyValue integerValue];
                self.payKillResultValue+= payValue;
            }else {
                [self.fsy_list addObject:[NSNumber numberWithInt:-1]];
                [self.fresult_list addObject:self.curSelectCustomer.luckyValue];
                [self.fyj_list addObject:[NSNumber numberWithDouble:0]];
                self.payKillResultValue-= [self.curSelectCustomer.luckyValue floatValue];
            }
        }
        [self fengzhuangChipTypeWith:self.curSelectCustomer];
    }
