...
@interface NRBaccaratViewController ()
//手动版视图
...
- (NRManualMangerView *)manuaManagerView{
    if (!_manuaManagerView) {
        _manuaManagerView = [[NRManualMangerView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.dewInfoView.frame)+20, kScreenWidth, kScreenHeight-CGRectGetMaxY(self.dewInfoView.frame)-20)];
...
- (void)uddateCurGameLuzhu{
    ...
    [modifyResultsView updateBottomViewBtnBaijiale:NO];
